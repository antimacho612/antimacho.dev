...
antimacho の技術メモ。
HTML / CSS / JavaScript の挙動や見た目を、**記事の中で実際に動かして確かめられる** ことを主眼にしている。
...
`main` への push で GitHub Actions が GitHub Pages に公開する（[.github/workflows/deploy.yml](.github/workflows/deploy.yml)）。
